...
// Этапы
// Код должен содержать функцию getNamesSortedByFriendsCount
// Если аргумент - пустой массив, то вызов функции getNamesSortedByFriendsCount([]) должен возвращать пустой массив.
// Вызов функции getNamesSortedByFriendsCount(users) должен возвращать['Moore Hensley', 'Sharlene Bush', 'Elma Head', 'Carey Barr', 'Blackburn Dotson', 'Sheree Anthony', 'Ross Vazquez'].
// Вызов функции getNamesSortedByFriendsCount для случайного массива должен возвращать отсортированый список имен.
...
// Исходный массив после вызова функции не должен изменить порядок элементов.
