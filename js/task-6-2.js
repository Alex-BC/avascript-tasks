...
// Ожидается массив объектов с заданным значением свойства 'eyeColor' из исходного массива users
// Ожидается массив объектов с заданным значением свойства 'eyeColor' из случайного исходного массива
...
// Ожидается использование деструктурирущего присваивания - { eyeColor }
