...
// Этапы
// Код должен содержать функцию getUsersWithAge
// Если в диапазон не попал ни один элемент,, то результатом вызова функции getUsersWithAge должен быть пустой массив.
// Результат вызова функции getUsersWithAge(users, 20, 30) должен возвращать массив объектов с 'name' и 'email'.
// Результат вызова функции getUsersWithAge(users, 30, 40) должен возвращать массив объектов с 'name' и 'email'.
