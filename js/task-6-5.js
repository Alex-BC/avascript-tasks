...
// Этапы
// Код должен содержать функцию getUserWithEmail
// Если элемент не найден, то результатом вызова функции getUserWithEmail должен быть 'undefined'
// Результат вызова функции getUserWithEmail(users, 'rossvazquez@xinware.com') должен возвращать элемент - объект с name: 'Ross Vazquez'
// Результат вызова функции getUserWithEmail(users, 'blackburndotson@furnigeer.com') должен возвращать элемент - объект с name: 'Blackburn Dotson'
// Ожидается использование метода 'find'
// Ожидается использование деструктурирущего присваивания - { email }
