...
// //  Этапы
// Код должен содержать функцию getSortedUniqueSkills
// Если аргумент пустой массив, то вызов функции getSortedUniqueSkills([]) также должен возвращать пустой массив.
// Вызов функции getSortedUniqueSkills(users) должен возвращать отсортированый массив значений из массивов`skills`.
// Вызов функции getSortedUniqueSkills со случайным массивом должен возвращать отсортированый массив значений из массивов`skills`.
